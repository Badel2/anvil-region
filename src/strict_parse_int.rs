...
mod tests {
    ...
    fn test_strict_parse_u32() {
        ...
        assert_eq!(strict_parse_u32(b"2147483646"), Some(u32::try_from(i32::MAX).unwrap() - 1));
        assert_eq!(strict_parse_u32(b"2147483647"), Some(u32::try_from(i32::MAX).unwrap()));
        assert_eq!(strict_parse_u32(b"2147483648"), Some(u32::try_from(i32::MAX).unwrap() + 1));
